...
<div class="card">
    <div class="card-header">
        ...
        <a href="/fitlib_root/admin/grupos_musculares/form" class="btn btn-add">Adicionar Novo</a>
    </div>

    <form method="GET" action="/fitlib_root/admin/grupos_musculares" class="filter-form">
        ...
        <tbody>
            <?php foreach ($grupos as $grupo): ?>
                <tr>
                    ...
                    <td>
                        <a href="/fitlib_root/admin/grupos_musculares/form?id=<?= $grupo['id_grupo_muscular'] ?>" class="btn btn-edit">Editar</a>
                        <a href="/fitlib_root/admin/grupos_musculares/delete?id=<?= $grupo['id_grupo_muscular'] ?>" class="btn btn-delete" onclick="return confirm('Tem certeza que deseja excluir este grupo muscular?');">Excluir</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
